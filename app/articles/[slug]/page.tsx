        ...
        <aside className="hidden md:flex fixed top-0 left-0 h-screen w-[60px] bg-[#0A0A0A] flex-col items-center z-20 rounded-r-2xl py-5 gap-3">
          ...
          <div className="flex flex-col gap-1 mb-4">
            {["STATS","STATS","STATS"].map((s,i)=>(
              <div key={i} className="bg-[#1a1a1a] text-gray-400 text-[8px] font-bold px-1 py-3 rounded-lg cursor-pointer hover:text-white writing-vertical"
                style={{writingMode:"vertical-rl",textOrientation:"mixed"}}>{s}</div>
            ))}
          </div>
        </aside>

        {/* Main content */}
        <main className="md:ml-[60px] flex-1 max-w-3xl mx-auto px-4 md:px-8 py-8">
          ...
          <div className="text-center mb-1">
            <p className="text-xs text-gray-400">Ralph Hawkins · May 7, 2019 · <span className="text-gray-600">X mins read</span></p>
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-2">
                  {["#technology","#tech","#Career","Lorem Ipsum","Lorem Ipsum","Lorem Ipsum","WPS"].map(k=>(
          ...
          {/* Hero image */}
          <div className="w-full h-48 md:h-64 bg-gradient-to-br from-gray-600 to-gray-400 rounded-2xl mb-6 overflow-hidden">
            <div className="w-full h-full flex items-center justify-center">
              <span className="text-white/40 text-lg font-medium">Article Hero Image</span>
            </div>
          </div>
          ...
          <div className="text-sm text-gray-700 leading-relaxed space-y-4">
            ...
            <p>Aliquip mollit sunt qui irure. Irure ullamco Lorem excepteur dolor qui ea ad quis. Enim fugiat cillum enim ad occaecat sint qui elit labore mollit sunt laborum fugiat consequat. Voluptate labore sunt duis eu deserunt. Occaecat do ut ut labore cillum enim dolore.</p>
          </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  Ipsum adipiscing culpa est nisi consequat ex amet magna culpa mollit laborum fugiat veniam tempor irure ea. Reprehenderit labore do tempor eiusmod in consectetur.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="mb-6">
              ...
              <div className="flex gap-3 bg-gray-50 rounded-xl p-4">
                ...
                <div className="flex-1 bg-white rounded-xl p-3 shadow-sm">
                  ...
                  <p className="text-xs text-gray-500 leading-relaxed">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                ...
                <thead>
                  <tr className="border-b border-gray-100">
                    {["Name","Date Created","Quality","Comments"].map(h=>(
                      <th key={h} className="text-xs text-gray-500 font-medium pb-3 text-left">{h}</th>
                    ))}
                    <th className="pb-3"/>
                  </tr>
                </thead>
                    ...
                    <tr key={i} className="border-b border-gray-50">
                      <td className="py-3">
                        <div className="flex items-center gap-2">
                          <div className="w-7 h-7 rounded-full bg-[#F97316] flex items-center justify-center text-white text-xs font-bold flex-shrink-0">S</div>
