...
const COMMISSIONS = [
  { id:"c1", title:"3000-word piece on EV Infrastructure in India", budget:"₹8,000",  deadline:"Apr 30", domain:"Technology" },
  { id:"c2", title:"Finance Guide for First-Time Investors",        budget:"₹6,500",  deadline:"May 5",  domain:"Finance"    },
  { id:"c3", title:"AI in Healthcare: Patient Perspective",         budget:"₹10,000", deadline:"May 10", domain:"Medical"    },
];
...
export default function WriterExplorePage() {
  ...
  // Commissions are static — no search / tag filter on that tab
    ...
    <AppLayout bg="bg-white">
      <div className="min-h-screen px-6 md:px-10 py-10">
        ...
        {tab === "Open Commissions" && (
          <>
            {/* Commission cards grid — no ghost placeholders */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              {visibleCommissions.map(c => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-[#f3f4f6]">
                    ...
                    <button className="bg-[#0a0a0a] text-white text-xs font-semibold px-4 py-2 rounded-lg hover:bg-[#374151] transition-colors cursor-pointer">
                      Apply
                    </button>
                  </div>
                </div>
