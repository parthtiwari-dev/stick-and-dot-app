...
const TOP_ARTICLES = [
  { id:"a1", rank:1, name:"The Silent Revolution in Neural Computing", rating:5, views:"12K Views",
    path:"M0,110 C40,110 40,90 80,80 C120,70 130,100 160,50 C190,10 220,35 260,20 C300,5 330,25 360,15 C390,5 400,8 400,8" },
  { id:"a2", rank:2, name:"How Minimalism Took Over the Design World",  rating:4, views:"9K Views",
    path:"M0,120 C40,115 60,105 100,100 C140,95 160,115 200,90 C240,65 260,75 300,55 C340,35 370,40 400,30" },
  { id:"a3", rank:3, name:"The Hidden Economics of Attention",           rating:4, views:"7K Views",
    path:"M0,100 C30,95 50,110 90,105 C130,100 150,80 200,70 C250,60 280,85 320,65 C360,45 380,50 400,40" },
];

export default function WriterDashboard() {
  const { userName } = useUser();
  const [selectedId, setSelectedId] = useState("a1");
  const selected = TOP_ARTICLES.find(a => a.id === selectedId) ?? TOP_ARTICLES[0];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 mb-4">
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl p-5 border border-gray-100">
            ...
            <div className="mt-3 pt-3 border-t border-gray-50">
              <Link href={`/articles/${selectedId}?own=1`}
          ...
          <div className="lg:col-span-3 bg-[#1A1A1A] rounded-2xl p-5">
            ...
            <p className="text-gray-500 text-xs mb-3 truncate">{selected.name}</p>
            <div className="relative h-40 w-full">
              <svg viewBox="0 0 400 140" className="w-full h-full" preserveAspectRatio="none">
                ...
                <path d={selected.path} stroke="#ffffff" strokeWidth="2" fill="none"/>
                <path d={`${selected.path} L400,140 L0,140 Z`} fill="url(#trafficGrad)"/>
